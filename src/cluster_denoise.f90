!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!                                                            !
! This is a Fortran subroutine to DENOISE an image using     !
! local pixel clustering and nonparametric regression. This  !
...
subroutine cluster_denoise(n, obsImg, bandwidth, mmt2, mmt4, &
     zq, estImg)
  ...
  double precision :: z(0:600, 0:600), mmt2, small, varnum, &
       ...
       ahat, bhat, chat, obsImg(0:n, 0:n), e, zbar,z1bar, z2bar, &
       varden, sd, z1ss, z2ss, zascend(1:1000), bwr(1:1000), &
       bwrLocalMax, cutoff, ttemp, fhat, mmt4, estImg(0:n, 0:n), zq
...
end subroutine cluster_denoise
